...
module YEA
  module MENU
    ...
    COMMANDS =[
      ...
      :equip,        # Opens up the equip menu. Default menu item.
      :skill,        # Opens up the skill menu. Default menu item.
      :event_3,      # Opens up Pokédex. (Common Event 5)
      :event_4,      # Shows Trainer Card. (Common Event 4)
    # :class,        # Requires YEA - Class System.
    ...
    # :command => ["Display Name", EnableSwitch, ShowSwitch, Event ID],
      ...
      :event_3 => [   "Pokédex",              5,          8,        5],
      :event_4 => [   "Trainer Card",   0,          0,        4],
    } # Do not remove this.
...
class Window_Base < Window
  ...
  def draw_actor_simple_status(actor, dx, dy)
    ...
    draw_actor_hp(actor, dx + 120, dy, dw)
    draw_actor_exp(actor, dx + 120, dy + 24, dw)
